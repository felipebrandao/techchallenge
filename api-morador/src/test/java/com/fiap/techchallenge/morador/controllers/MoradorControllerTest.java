...
public class MoradorControllerTest {
    ...
    private static final String MORADOR_ENDPOINT = "/api/morador";
    ...
    public void testRegistrarMorador() throws Exception {
        ...
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post(MORADOR_ENDPOINT)
    ...
    public void testPesquisarMoradores() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(MORADOR_ENDPOINT + "/pesquisar")
                        .param("idPessoa", "1")
                        .param("idEndereco", "2"))
